...
def selecionar_arquivo_e_diretorio():
    ...
    root.destroy()
    return path_to_file_pagos, subtitulo, path_to_file_sus_aih
...
def generate_pdf_table(output_file_path, nome_medico, subtitulo, data_pagos=[], data_sus_aih = []):
    ...
    if data_pagos and data_sus_aih:
...
path_to_file_pagos =  'C:/Users/ACER/Meu Drive/Hospital Nossa Senhora das Mercês/Códigos Python/Códigos Funcionando/Arquivos TXT SPData/Relatório Lucas Ferreira Neres - Jan 2024 - jun 2024.TXT'
# path_to_file_sus_aih = 'C:/Users/ACER/Meu Drive/Hospital Nossa Senhora das Mercês/Códigos Python/Códigos Funcionando/Arquivos TXT SPData/juarez-e-rodrigo/Juarez - sus - aih - jan-2023-dez-2023.TXT.TXT'
...
# dados_processados_sus_aih_df = dados_sus_aih(lines_list_sus_aih)
...
todos_medicos = set(dados_medicos_pagos.keys()) #| set(dados_medicos_sus_aih.keys())
...
for nome_medico in todos_medicos:
    ...
    if tabelas_pagos : #or tabelas_sus_aih:
        generate_pdf_table(caminho_completo, titulo_texto, subtitulo, tabelas_pagos)#, tabelas_sus_aih)
